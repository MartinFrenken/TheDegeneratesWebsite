...
export default function TeamMembers(props) {
    ...
    return<>
        ...
        <Row  type="flex" align="center" justify ="center" >
            <p style={{paddingTop:"73px",paddingBottom:"20px",fontSize:"15px", fontWeight:"600",color:"white", wordWrap:"break-word", inlineSize:"1000px", marginRight:"auto",marginLeft:"auto", textAlign:"center"}}>This website is still under development.</p>
        </Row>
