...
" >
        ...
        <Utility imageIcon ="/utility_icons/staking.png"
                     title ="Staking"
                 text ="We are currently developing an app through which you will be able to stake your NFT for $DEGN coins. With these coins you can buy many benefits which we designed in a way, to give you even more money back. For example, a free mint pass of our 2nd generation or even a free NFT." >
        </Utility>

        <Utility imageIcon ="/utility_icons/metaverse.png"
                     title ="Metaverse"
                 text ="We see a future where the Metaverse will be a part of our everyday life. This is why we decided to also go along this path. Not only do you get a fine 2D NFT art, but you will be also able to download an exclusive 3D skin of your DEGENERATE on our app. We are also thinking about airdropping them to your metamask accounts. We are also currently speaking with Decentraland regarding a partnership, so stay tuned!
" >
        </Utility>
        <Utility imageIcon ="/utility_icons/cool_nft_art.png"
                     title ="Cool NFT art"
                 text ="The Degenerates are consisting of 3 tribes, where each tribe has its own unique form. Not one NFT looks alike, because of the art combination of traits. Together there are more than 200 complex singular traits which interact with each other flawlessly." >
        </Utility>
