...
export default function TheApp() {
    return <Row style={{paddingTop:72,paddingRight:40,paddingLeft:40}} type="flex" align="center" justify ="center">
        ...
        <p style={{color:"white",fontSize:15,fontWeight:600,marginTop:30,alignContent:"center",textAlign:"center"}}>The degenerate app is for the community and for you to have a closer interaction with us and the NFT itself. We will be giving you weekly updates about our progress, our crypto newsletter, and NFTs to watch, we hope that this will be really helpful for you. Aside from the work we will do for you, you will be able to claim your monthly passive income, stake your NFT and buy stuff in the shop part using our $DEGN coins.
