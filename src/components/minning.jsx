...
return <>
    ...
    <Col xs={0} md={0 } lg={15}>
        <div style={{boxSizing: "border-box",border: "10px solid #3F54A0", borderRadius:"30px", background:"rgba(8, 8, 49, 0.55)",marginRight:72,marginLeft:72}}>
            ...
            Crypto mining is one of the most profitable businesses right now. The only problem emerges when people try to get GPUs or ASIC miners for the endeavor. Even if you would find these miners and GPUs , they would be vastly overpriced. We are solving this problem with reliable contacts and sources in China. Invest in the NFT like a shareholder, where you will be given a dividend profit every month.
            <br></br>
            ...
            <br></br>
            We expect a ROI of 1 year in a more pessimistic case, in the case bitcoin would rise to around 60 000$ again, you could have your investment back in less than 7 months.
